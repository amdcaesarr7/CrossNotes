...
const subjects: SubjectMeta[] = [
  ...
  { id: 2, name: "Science 2",          slug: "science-2", emoji: "🔬", color: "science", description: "Advanced Biology & Life Sciences",    isLive: false },
  { id: 3, name: "Maths 1 (Algebra)",  slug: "maths-1",   emoji: "📐", color: "math",    description: "Algebra, Equations & Polynomials",   isLive: false },
  { id: 4, name: "Maths 2 (Geometry)", slug: "maths-2",   emoji: "📊", color: "math",    description: "Geometry, Circles & Trigonometry",   isLive: false },
